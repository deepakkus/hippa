...
class FormElements extends Component {
  constructor(props) {
    ...
    this.state = {
      breadcrumbItems: [
        { title: "Doner Request", link: "#" },
        { title: "Manage Doner Request", link: "#" },
      ],
      customchk: true,
      toggleSwitch: true,
      // page states
  ...
  fetchData = async () => {
    let result = await HttpClient.requestData("donor", "GET");
        ...
        let rows = {
          ...
          report: (
            <div>
              ...
              <p>
                Like:{" "}
                {element.reacts.filter((item) => item.isLike == true).length}
              </p>
              <p>
                Dislike:{" "}
                {element.reacts.filter((item) => item.isLike == true).length}
